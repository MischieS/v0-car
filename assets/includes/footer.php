								...
								<div class="col-lg-4 col-md-6">
									...
									<div class="footer-widget footer-menu">
										...
										<ul>
											...
											<li>
												<a href="booking_list.php">Booking</a>
											</li>
											<li>
							...
							<div class="col-md-6">
								...
								<div class="copyright-menu">
									<div class="vistors-details">
										<ul class="d-flex">											
											<li><a><img class="img-fluid" src="assets/img/icons/paypal.svg" alt="Paypal"></a></li>											
											<li><a><img class="img-fluid" src="assets/img/icons/visa.svg" alt="Visa"></a></li>
											<li><a><img class="img-fluid" src="assets/img/icons/master.svg" alt="Master"></a></li>
											<li><a><img class="img-fluid" src="assets/img/icons/applegpay.svg" alt="applegpay"></a></li>
										</ul>										   								
									</div>
								</div>
								<!-- /Copyright Menu -->
