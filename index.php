            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="car-card">
                            <div class="car-image">
                                <img src="<?php echo htmlspecialchars($car['car_image'] ?? 'assets/img/cars/default-car.jpg'); ?>" alt="<?php echo htmlspecialchars($car['car_type']); ?>">
                            </div>
                            <div class="car-details">
                                <h3 class="car-title"><?php echo htmlspecialchars($car['car_type']); ?></h3>
                                <div class="car-meta">
                                    <div class="car-meta-item">
                                        <i class="fas fa-car"></i> <?php echo htmlspecialchars($car['car_class'] ?? 'Sedan'); ?>
                                    </div>
                                    <div class="car-meta-item">
                                ...
                                <div class="car-price">
                                    <div>
                                        <span class="price-value">$<?php echo htmlspecialchars($car['car_price_perday']); ?></span>
